...
public class MyContactRushRecyclerViewAdapter extends RecyclerView.Adapter<MyContactRushRecyclerViewAdapter.ViewHolder> {
    ...
    public MyContactRushRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_contactrush, parent, false);
